...
export const SHOP_GADGETS: Gadget[] = [
  ...
  },
  {
    ...
    category: 'effect',
    rarity: 'rare',
    description: 'Bubbles float up with every win.',
  },
  {
    id: 'petals',
    name: 'Flower petals',
    ...
    category: 'effect',
    rarity: 'rare',
    description: 'Pink petals drift around Zico.',
  },
  {
    id: 'music',
    name: 'Music notes',
    ...
    category: 'effect',
    rarity: 'epic',
    description: 'A little tune floats by.',
  },
  {
    id: 'ice',
    name: 'Ice shards',
    ...
    category: 'effect',
    rarity: 'epic',
    description: 'Cool crystal shards, always chill.',
  },
  {
    id: 'fire',
    name: 'Fire flames',
    ...
    category: 'effect',
    rarity: 'legendary',
    description: 'Warm flames flicker at his feet.',
  },
];
